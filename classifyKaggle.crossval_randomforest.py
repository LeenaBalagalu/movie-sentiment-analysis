...
def cross_validation_PRF(num_folds, featuresets, labels, tfidf_matrix):
    ...
    for fold in range(num_folds):
        ...
        fold_accuracy = (y_pred == y_test).sum() / len(y_test)
    ...
    average_accuracy = total_accuracy / num_folds  # Average accuracy across all folds
    ...
    print(f'\nOverall Average Accuracy: {average_accuracy:.3f}')
